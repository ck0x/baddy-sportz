  ...
  const products = [
    {
      ...
      brand: "Yonex",
      description: "Professional-grade racket with exceptional control and power.",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=300",
      brand: "Yonex",
      description: "Durable synthetic shuttlecocks for training and recreational play.",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=300",
      brand: "Yonex",
      description: "Comfortable and breathable polo shirt for training and matches.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-blue-50 pt-20">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Discover our extensive collection of professional badminton equipment from top brands. Visit our store to
            purchase and get expert advice.
          </p>
          <div className="bg-gradient-to-r from-emerald-600 to-blue-600 text-white px-6 py-3 rounded-full inline-block">
            <span className="font-semibold">Visit our store to purchase • Expert advice included</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-emerald-600 to-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">Ready to Get Your Equipment?</h2>
          <p className="text-xl mb-8 opacity-90">
            Visit our store to see, feel, and test the equipment before purchasing. Our experts will help you find the
            perfect gear for your playing style.
          </p>
