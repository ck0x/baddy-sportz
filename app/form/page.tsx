...
import { CheckCircle, User, Phone, Mail, Zap, Settings, FileText } from "lucide-react"
			...
			<div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-50 flex items-center justify-center p-6">
				<Card className="w-full max-w-md text-center shadow-xl border-0 bg-white">
					<CardContent className="pt-12 pb-8">
						...
						<h2 className="text-3xl font-bold text-slate-800 mb-3">Thank Theou!</h2>
						<p className="text-slate-600 mb-8 text-lg leading-relaxed">
							Your order has been submitted successfully. We'll take great care of your racket!
						</p>
						<Button
							onClick={resetForm}
			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="text-center mb-10">
					<div className="bg-slate-800 text-white p-8 rounded-2xl mb-8 shadow-xl">
						...
						<p className="text-xl text-slate-200 font-medium">Professional racket stringing services</p>
						<p className="text-lg text-slate-300 mt-2">Please fill out your details below</p>
					</div>
				</div>
					...
					<CardContent className="p-8">
						<form onSubmit={handleSubmit} className="space-y-8">
							...
							<div className="space-y-6">
								...
								<div className="space-y-3">
									<Label htmlFor="email" className="text-base font-medium flex items-center gap-2 text-slate-700">
							...
							<div className="space-y-6">
								<div className="flex items-center gap-3 pb-4 border-b border-slate-200">
									...
									<h3 className="text-xl font-semibold text-slate-800">Racket Details</h3>
								</div>

								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
									<div className="space-y-3">
										<Label htmlFor="racketBrand" className="text-base font-medium text-slate-700">
											Racket Brand *
										</Label>
										<Select
											value={formData.racketBrand}
											onValueChange={(value) => handleInputChange("racketBrand", value)}
										>
									...
									<div className="space-y-3">
										<Label htmlFor="racketModel" className="text-base font-medium text-slate-700">
											Racket Model *
										</Label>
										<Input
											id="racketModel"
											...
											onChange={(e) => handleInputChange("racketModel", e.target.value)}
											required
											className="text-lg p-4 h-14 border-2 border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 rounded-lg"
										/>
									</div>
								...
								<div className="space-y-3">
									<Label htmlFor="stringType" className="text-base font-medium text-slate-700">
							...
							<div className="space-y-6">
								<div className="flex items-center gap-3 pb-4 border-b border-slate-200">
									...
									<h3 className="text-xl font-semibold text-slate-800">Service Type</h3>
								</div>
								...
								>
									<div className="flex items-center space-x-4 p-6 border-2 border-slate-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 cursor-pointer">
										...
										<div className="flex-1">
											<Label htmlFor="standard" className="text-lg font-semibold cursor-pointer block text-slate-800">
												Standard Service
											</Label>
											<p className="text-slate-600 mt-1">Regular stringing service</p>
										</div>
									</div>

									<div className="flex items-center space-x-4 p-6 border-2 border-slate-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 cursor-pointer">
										<RadioGroupItem value="premium" id="premium" className="w-5 h-5" />
										<div className="flex-1">
											<Label htmlFor="premium" className="text-lg font-semibold cursor-pointer block text-slate-800">
												Premium Service
											</Label>
											<p className="text-slate-600 mt-1">Express + quality guarantee</p>
										</div>
									</div>
								</RadioGroup>
							</div>
